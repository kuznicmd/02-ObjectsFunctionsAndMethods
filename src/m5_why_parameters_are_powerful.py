...
def main():
    ...
    # better_draw_circles(rg.Point(300, 50), 3)
    # better_draw_circles(rg. Point(-200, -100), 10)
    # even_better_draw_circles(rg.Point(100, -200), 10, 10, 'blue', 2)
    # even_better_draw_circles(rg.Point(-200, 50), 15, 4, 'red', 7)
    even_better_draw_circles(rg.Point(-250, 150), 15, 20, 'pink', 5)
    even_better_draw_circles(rg.Point(100, -50), 20, 15, 'blue', 10)
    even_better_draw_circles(rg.Point(50, 200), 5, 30, 'red', 3)
    even_better_draw_circles(rg.Point(-300, -200), 10, 15, 'yellow', 2)
...
def even_better_draw_circles(point, radii, number_of_circles, color, thickness):
